...
def ct_slice(z: int, n_slices: int, size=256, scramble=False, body_part="CHEST") -> bytes:
...
if __name__ == "__main__":
    ...
    ap.add_argument("--body-part", default="CHEST",
                    help="BodyPartExamined for the CT series (e.g. HEAD, ABDOMEN)")
    args = ap.parse_args()
